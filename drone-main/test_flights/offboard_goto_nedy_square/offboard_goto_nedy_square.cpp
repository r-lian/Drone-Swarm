...
int main(int argc, char** argv)
{
	...
	drone.offboard_goto_nedy(0.0f, 0.0f, -1 * side_length, 0.0f, speed);
	drone.offboard_goto_nedy(side_length, 0.0f, -1 * side_length, 0.0f, speed);
	drone.offboard_goto_nedy(side_length, side_length, -1 * side_length, 0.0f, speed);
	drone.offboard_goto_nedy(0.0f, side_length, -1 * side_length, 0.0f, speed);
	drone.offboard_goto_nedy(0.0f, 0.0f, -1 * side_length, 0.0f, speed);
