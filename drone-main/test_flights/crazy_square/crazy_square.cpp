...
int main(int argc, char** argv)
{
	...
	// square action nedy
	drone.offboard_velocity_goto_nedy(0.0f, 0.0f, -10.0f, 0.0f, 10.0f);
	drone.offboard_velocity_goto_nedy(10.0f, 0.0f, -10.0f, 0.0f, 10.0f);
	drone.offboard_velocity_goto_nedy(10.0f, 10.0f, -10.0f, 0.0f, 10.0f);
	drone.offboard_velocity_goto_nedy(0.0f, 10.0f, -10.0f, 0.0f, 10.0f);
	drone.offboard_velocity_goto_nedy(0.0f, 0.0f, -10.0f, 0.0f, 10.0f);
